...
async function loadLessonQuestions(){
  ...
  teacherQuestions=questions.map((q,index)=>{
    ...
    return {...q,id,tokens:cleaned.tokens,acceptedOrders:cleaned.acceptedOrders,flexibleFrames,displaySentence:cleaned.displaySentence,enabled:true,edited:false,custom:false};
