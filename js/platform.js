...
function render(){
  ...
  const name=gameName();
  els.guide.textContent=selectedGame==='sentence'?'문장 배틀에서 사용할 서울대 한국어 교재와 과를 선택하세요.':selectedGame==='matching'?'카드 매칭에 사용할 한국어·몽골어 어휘 자료를 선택하세요.':selectedGame==='memory'?'기억력 배틀에 사용할 한국어·몽골어 어휘 자료를 선택하세요.':selectedGame==='search'?'몽골어 뜻을 보고 한국어 단어를 찾을 어휘 자료를 선택하세요.':selectedGame==='combined'?'세 게임을 연속 진행할 서울대 한국어 교재와 과를 선택하세요.':'어휘 배틀에서 사용할 자료를 선택하세요.';
